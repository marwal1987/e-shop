...
//import ProductCard from '.components/ProductCard'; // Importera ProductCard-komponenten
    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {products.map((product) => (
          <ProductCard key={product.id} product={product} /> // Rendera ProductCard för varje produkt
        ))}
      </div>
    </div>
  );
